  ...
  useEffect(() => {
    try {
      ...
      if (savedStateString) {
        ...
        addResult("Game state loaded successfully.");
      } else {
      ...
      <div className="game-content">
        <div className="left-panel">
          ...
          <div className="title-container">
            <h1>Idle Craps</h1>
            <AccountSystem onLogin={handleLogin} onLogout={handleLogout} onSaveState={handleSaveState} gameState={{}} isLoggedIn={isLoggedIn} currentUser={currentUser} isAdmin={isAdmin} lastSaveTime={lastSaveTime} />
